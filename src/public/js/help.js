...
function resize_header(){
    if (window.matchMedia("(min-width: 930px)").matches) {
        ...
        document.getElementById("flex_menu").innerHTML = `
            <a href="/help" class="flex_menu_text_active" id="menu_help_text">Help</a><a href="/help" class="flex_menu_item" id="menu_help"><img src="/public/img/help_outline_black_24dp.svg" class="menu_icon_active" /></a>
            <a href="/control_panel" class="flex_menu_text_inactive" id="menu_control_panel_text">Control Panel</a><a href="/control_panel" class="flex_menu_item" id="menu_control_panel"><img src="/public/img/tune_black_24dp.svg" class="menu_icon_inactive" /></a>
            <a href="/settings" class="flex_menu_text_inactive" id="menu_settings_text">Settings</a><a href="/settings" class="flex_menu_item" id="menu_settings"><img src="/public/img/settings_black_24dp.svg" class="menu_icon_inactive" /></a>
            <a href="/logout" class="flex_menu_text_inactive" id="menu_logout_text">Log out</a><a href="/logout" id="logout" class="flex_menu_item" ><img src="/public/img/logout_black_24dp.svg" class="menu_icon_inactive" /></a>
        `;
        add_logout_listener();
    } else {
        document.getElementById("flex_menu").innerHTML = `
